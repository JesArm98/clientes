...
const MobileMenu = () => {
  ...
  const menuItems = [
    { name: "Equipos", href: "#objetivo" },
    { name: "Facturas", href: "#estancias2" },
    { name: "Certificados", href: "#habitaciones" },
    { name: "Estado de Cuenta", href: "#instalaciones" },
    { name: "Firesys", href: "#actividades2" },
  ];
          ...
          <List>
            {menuItems.map((item, index) => (
              ...
              >
                <ListItemText
                  primary={item.name}
                  primaryTypographyProps={{ style: { fontSize: "30px", textAlign: "center" } }}
                />
              </ListItem>
            ))}
          </List>
